...
public class HelpCommand extends PKCommand {
	...
	public void execute(CommandSender sender, List<String> args) {
		...
		} else if (Arrays.asList(Commands.spiritaliases).contains(args.get(0))) { 
			sender.sendMessage(ChatColor.YELLOW + "Spirits are able to Posses their victim and haunt them to death, or help them as a friend. " + ChatColor.GRAY + "/b display Spirit" + ChatColor.YELLOW + " for more information about Spirit(s).");
